...
This commit covers the half a browser can reach: customer reuse, checkout
parameters, the configuration refusals, and the authority rules. The webhook and
the hosted portal arrive with their own tests in later commits.
"""
...
PERIOD_END = datetime.fromtimestamp(1790000000, tz=UTC)  # 2026-09-21T14:13:20Z
